// fishing.Router = Backbone.Router.extend({

//   routes: {
//     ""               : "showIndex",
//     "join"           : "showJoins",
//     "new-tournament" : "showNew-Tournament",
//     "entry"          : "showEntry",
//     "stats"          : "showStats" 
//   },
...
//       React.createElement(
//         fishing.views.Header,
//         {model: fishing.currentUser}
//       ),
//       $("header").get(0)
//     );
...
//       React.createElement(
//         fishing.views.BreadCrumbs,
//         {model: fishing.currentUser}
//       ),
//       $("nav").get(0)
//     );

//     this.tasks = fishing.currentUser.id ? new fishing.models.Tasks() : null;
...
//     this.listenTo(fishing, "sign:out", function(){
//       this.tasks = null;
//       this.main.setProps({collection: this.tasks});
//     });

//     this.listenTo(fishing, "sign:in", function(){
//       this.tasks = new fishing.models.Tasks();
//       this.main.setProps({collection: this.tasks});
//     });
//   },
